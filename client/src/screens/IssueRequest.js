...
import {getAllBookIssueReq ,issuedReq} from "../actions/Issue_action"
...
const IssueRequest = () => {
    ...
    return (
        <div className="col-md-10 m-auto">
             <p style={{fontFamily:"sans-serif",fontSize:"30px",textAlign:"center",padding:"10px"}}>Student Requested to Admin add this Book</p>
...
{newIssuedBook && newIssuedBook.map(book=>{
    ...
    return <tr key={book._id} >
        ...
        <td>
             ...
             <button onClick={() => dispatch(issuedReq(book._id))} className="btn btn-danger">Rejected</button>
        </td>
